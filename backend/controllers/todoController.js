...
// ============================================
// СЪЗДАВА НОВА БЕЛЕЖКА (ЗА ТЕКУЩИЯ ПОТРЕБИТЕЛ)
// ============================================
export const createTask = async (req, res) => {
  const { task } = req.body;
  if (!task) {
    return res.status(400).json({ success: false, message: 'Полето бележка не може да е празно!' });
  }
  if (task.length > 255) {
    return res.status(400).json({
      message: 'Бележката е прекалено дълга!'
    });
  }
  try {
    const userId = req.user.id; // Вземаме от JWT токена
...
// ============================================
// ВЗИМА ЕДНА БЕЛЕЖКА (САМО АКО Е НА ТЕКУЩИЯ ПОТРЕБИТЕЛ)
// ============================================
...
// ============================================
// ПРОМЕНЯ СТАТУСА НА БЕЛЕЖКА (САМО АКО Е НА ТЕКУЩИЯ ПОТРЕБИТЕЛ)
// ============================================
...
// ============================================
// ПРОМЕНЯ ТЕКСТА НА БЕЛЕЖКА (САМО АКО Е НА ТЕКУЩИЯ ПОТРЕБИТЕЛ)
// ============================================
...
// ============================================
// ИЗТРИВА БЕЛЕЖКА (САМО АКО Е НА ТЕКУЩИЯ ПОТРЕБИТЕЛ)
// ============================================
